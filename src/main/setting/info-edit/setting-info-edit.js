...
const SettingInfoEdit = () => {
	...
	return (
		<main
			className={classNames(styles.SettingInfoEditRoot, {
				[styles.SettingInfoEditRootMobile]: isMobile,
			})}
		>
			<SettingTab isInfoEditActive={true}></SettingTab>
			<div
				className={classNames(styles.SettingInfoEditContent, {
					[styles.SettingInfoEditContentMobile]: isMobile,
				})}
			>
