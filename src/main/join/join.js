    ...
    return (
        <>
            <div className={styles.JoinFormInner}>
                ...
                <p className={styles.JoinInputTitle}>상태 메시지 (다른 사람에게 보이고 싶은 한마디)</p>
                <InputBox type="text"></InputBox>
                ...
                <div className={styles.JoinEmail}>
                    <InputBox type="text"></InputBox>
                    <PrimamryButton buttonText="인증번호 전송"></PrimamryButton>
                </div>
                <p className={styles.JoinInputTitle}>이메일 확인</p>
                <div className={styles.JoinEmail}>
                    <InputBox type="text"></InputBox>
                    <PrimamryButton buttonText="인증번호 확인"></PrimamryButton>
                </div>
                <div className={styles.JoinBtn}>
                <PrimamryButton buttonText="회원가입"></PrimamryButton>
                </div>
            </div>
        </>
    )
