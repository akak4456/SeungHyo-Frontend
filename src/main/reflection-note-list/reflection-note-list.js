...
const ReflectionNoteListTable = props => {
    return (
        <table className={styles.ReflectionNoteListTableRoot}>
            ...
            <tr>
                <td>1000</td>
                <td><NavLink to={'/reflection-note/1000'} className={styles.reflectionNoteListCorrect}>A + B</NavLink></td>
                <td className={styles.reflectionNoteListCorrect}>맞았습니다</td>
                <td>31120 <span className={styles.reflectionNoteListWrong}>KB</span></td>
                <td>44 <span className={styles.reflectionNoteListWrong}>ms</span></td>
                <td>C++</td>
                <td>528 <span className={styles.reflectionNoteListWrong}>B</span></td>
                <td>11분전</td>
            </tr>
            <tr>
                <td>1000</td>
                <td><NavLink to={'/reflection-note/1000'} className={styles.reflectionNoteListWrong}>A + B</NavLink></td>
    ...
    return (
        <>
            ...
            <main className={styles.ReflectionNoteListRoot}>
                <div className={classNames(styles.ReflectionNoteListSearchContainer, {[styles.ReflectionNoteListSearchContainerTablet]: isTablet})}>
